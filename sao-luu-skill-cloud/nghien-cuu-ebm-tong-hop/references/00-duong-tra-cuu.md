# Đường tra cứu y văn — đường nào chạy được, đường nào không

> Đọc file này **trước khi tra bất cứ thứ gì**. Căn cứ: phép đo **gọi thật** ngày 2026-09-05
> trong phiên cloud. Bản gốc dùng chung cho 5 skill tra cứu (`paper-lookup`,
> `citation-management`, `research-lookup`, `literature-review`, skill này) — sửa thì sửa cả 5.
